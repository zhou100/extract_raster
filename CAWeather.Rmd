...
tmin0708 = tmin_zmw %>% dplyr::filter(Date>="2007-10-01" & Date<"2008-07-01")
tmin0809 = tmin_zmw %>% dplyr::filter(Date>="2008-10-01" & Date<"2009-07-01")
tmin0910 = tmin_zmw %>% dplyr::filter(Date>="2009-10-01" & Date<"2010-07-01")
tmin1011 = tmin_zmw %>% dplyr::filter(Date>="2010-10-01" & Date<"2011-07-01")


tmax_zmw$Date= as.Date(tmax_zmw$Date,"%m/%d/%Y")
tmax0708 = tmax_zmw %>% dplyr::filter(Date>="2007-10-01" & Date<"2008-07-01")
tmax0809 = tmax_zmw %>% dplyr::filter(Date>="2008-10-01" & Date<"2009-07-01")
tmax0910 = tmax_zmw %>% dplyr::filter(Date>="2009-10-01" & Date<"2010-07-01")
tmax1011 = tmax_zmw %>% dplyr::filter(Date>="2010-10-01" & Date<"2011-07-01")
...
rain0708 = rain0718 %>% dplyr::filter(Date>="2007-10-01" & Date<"2008-07-01") 
rain0809 = rain0718 %>% dplyr::filter(Date>="2008-10-01" & Date<"2009-07-01") 
rain0910 = rain0718 %>% dplyr::filter(Date>="2009-10-01" & Date<"2010-07-01") 
rain1011 = rain0718 %>% dplyr::filter(Date>="2010-10-01" & Date<"2011-07-01") 
